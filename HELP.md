...
* The original package name 'de.htwg-in-schneider.checkmate.checkmate-backend' is invalid and this project uses 'de.htwg_in_schneider.checkmate.checkmate_backend' instead.
